...
**接口**: `POST /api/v1/account/report`

**请求示例**:
```bash
curl --location 'http://localhost:8888/api/v1/account/report' \
--header 'Content-Type: application/json' \
--data '{
    "start_date": "2026-01-22",
    "end_date": "2026-01-22",
    "advertiser_id": 95790770,
...
| advertiser_id | int64 | 是 | 广告主 ID |
| temporal_granularity | string | 否 | 时间粒度: DAILY/WEEKLY/MONTHLY，默认 DAILY |
...
**接口**: `POST /api/v1/account/batch_report`

**请求示例**:
```bash
curl --location 'http://localhost:8888/api/v1/account/batch_report' \
--header 'Content-Type: application/json' \
--data '{
    "start_date": "2026-01-22",
    "end_date": "2026-01-22",
    "advertiser_ids": [95790770, 95790771],
    "temporal_granularity": "DAILY"
}'
```
...
| advertiser_ids | []int64 | 是 | 广告主 ID 列表 |
| temporal_granularity | string | 否 | 时间粒度，默认 DAILY |
